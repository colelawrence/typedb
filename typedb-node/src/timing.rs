...
//! Timing instrumentation for Node-API benchmarks.
//!
...
pub struct TimingBreakdown {
    ...
    /// Total native-side time (us)
    pub native_total_us: u64,
}
...
impl TimingBreakdown {
    ...
    pub fn new() -> Self {
        Self { parse_us: 0, compile_us: 0, execute_us: 0, serialize_us: 0, native_total_us: 0 }
    }
    ...
    pub fn finalize(&mut self) {
        self.native_total_us = self.parse_us + self.compile_us + self.execute_us + self.serialize_us;
    }
}
