...
mod tests {
    ...
    fn create_in_memory_database() {
        let _db = TestDatabase::new_in_memory("test_create");
        // Database created successfully - no panic means success
    }

    #[test]
    fn create_multiple_databases() {
        let _db1 = TestDatabase::new_in_memory("test_db1");
        let _db2 = TestDatabase::new_in_memory("test_db2");
        let _db3 = TestDatabase::new_in_memory("test_db3");
    ...
    fn database_drop_cleanup() {
        {
            let _db = TestDatabase::new_in_memory("test_drop");
