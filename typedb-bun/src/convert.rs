...
//! Type conversion from typedb-embedded types to FFI types.
...
/// Convert embedded AttributeValue to FFI AttributeValue.
...
/// Convert embedded Value to FFI Value.
...
/// Convert embedded SchemaSummary to FFI SchemaSummary.
